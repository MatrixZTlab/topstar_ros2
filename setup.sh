...
# WiFi path: reach A via wlp4s0 (192.168.1.12) on the same WiFi subnet — no cross-subnet routing needed.
export CYCLONEDDS_URI='<CycloneDDS><Domain><General><Interfaces><NetworkInterface name="wlp132s0f0" priority="default" multicast="default"/></Interfaces><MaxMessageSize>1438B</MaxMessageSize></General><Discovery><Peers><Peer Address="192.168.1.12"/></Peers></Discovery></Domain></CycloneDDS>'
